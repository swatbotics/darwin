...
///
/// ikfast version 55 generated on 2012-06-15 15:34:40.519782
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
eetrans[0]=((-0.0370000000000000)+(((x10)*(((((0.0930000000000000)*(x7)))+(((0.0930000000000000)*(x6)))))))+(((-1.00000000000000)*(x31)))+(((x5)*(((((-1.00000000000000)*(x31)))+(x30)))))+(x30)+(((0.0335000000000000)*(x2)*(x28)*(x29)))+(((-1.00000000000000)*(x13)*(((((0.0335000000000000)*(x20)*(((((-1.00000000000000)*(x23)))+(((-1.00000000000000)*(x21)))))))+(((0.0335000000000000)*(x19))))))));
eerot[3]=((((x29)*(x42)))+(((-1.00000000000000)*(x13)*(x3))));
eerot[4]=((((x29)*(x3)))+(((x13)*(x42))));
eerot[5]=((((x14)*(x35)))+(((x20)*(((((-1.00000000000000)*(x37)))+(x38))))));
eetrans[1]=((-0.122200000000000)+(((-0.0930000000000000)*(x38)))+(((-0.0930000000000000)*(x0)*(x28)))+(((0.0930000000000000)*(x37)))+(((-0.0335000000000000)*(x29)*(x3)))+(((x13)*(((((0.0335000000000000)*(x40)))+(((0.0335000000000000)*(x36))))))));
eerot[6]=((((x1)*(x13)*(x28)))+(((x29)*(x59))));
eerot[7]=((((x13)*(x59)))+(((-1.00000000000000)*(x1)*(x28)*(x29))));
eerot[8]=((((x14)*(x56)))+(((x20)*(x51))));
eetrans[2]=((-0.00500000000000000)+(((0.0335000000000000)*(x1)*(x28)*(x29)))+(((-1.00000000000000)*(x5)*(x62)))+(((x10)*(((((-0.0930000000000000)*(x43)))+(((1.00000000000000)*(x3)*(x30)))))))+(((x13)*(((((-0.0335000000000000)*(x52)))+(((-0.0335000000000000)*(x58)))))))+(((-1.00000000000000)*(x62))));
}
...
IKFAST_API const char* getKinematicsHash() { return "f71f7539123a504067f97cd780faad41"; }
